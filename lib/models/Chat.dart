...
class Chat extends Model {
  ...
  const Chat._internal({required this.id, name, adminId, type, members, createdAt, updatedAt}): _name = name, _adminId = adminId, _type = type, _members = members, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Chat({String? id, String? name, String? adminId, ChatType? type, List<UserChat>? members}) {
    return Chat._internal(
      id: id == null ? UUID.getUUID() : id,
      name: name,
      adminId: adminId,
      type: type,
      members: members != null ? List<UserChat>.unmodifiable(members) : members);
  }
  ...
  Chat copyWith({String? id, String? name, String? adminId, ChatType? type, List<UserChat>? members}) {
    return Chat._internal(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  Chat.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _type = enumFromString<ChatType>(json['type'], ChatType.values),
